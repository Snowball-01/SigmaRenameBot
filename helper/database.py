...
class Database:
    ...
    async def set_format_template(self, id, format_template):
        await self.config.update_one({'_id': int(id)}, {'$set': {'format_template': format_template}})
    ...
    async def set_autorename(self, id, autorename):
        await self.config.update_one({'_id': int(id)}, {'$set': {'autorename': autorename}})
    ...
    async def set_media_preference(self, id, media_type):
        await self.config.update_one({'_id': int(id)}, {'$set': {'media_type': media_type}})
    ...
    async def set_metadata(self, id, bool_meta):
        await self.config.update_one({'_id': int(id)}, {'$set': {'metadata': bool_meta}})
    ...
    async def set_metadata_code(self, id, metadata_code):
        await self.config.update_one({'_id': int(id)}, {'$set': {'metadata_code': metadata_code}})
