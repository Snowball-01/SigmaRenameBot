...
from pyrogram.types import CallbackQuery, InlineKeyboardButton, InlineKeyboardMarkup, InputMediaPhoto, ForceReply
    ...
    if data == "home":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([[
                InlineKeyboardButton('⛅ ᴜᴘᴅᴀᴛᴇ', url='https://t.me/Kdramaland'),
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[
                InlineKeyboardButton("⚙️ sᴇᴛᴜᴘ ᴀᴜᴛᴏ ʀᴇɴᴀᴍᴇ ғᴏʀᴍᴀᴛ ⚙️", callback_data='file_names')
                ],[
                InlineKeyboardButton('🖼️ ᴛʜᴜᴍʙɴᴀɪʟ', callback_data='thumbnail'),
                InlineKeyboardButton('✏️ ᴄᴀᴘᴛɪᴏɴ', callback_data='caption')
                ],[   
                InlineKeyboardButton('⌨ ғɪʟᴇ sᴇǫᴜᴇɴᴄᴇ', callback_data='sequence'),
                InlineKeyboardButton('📟 ᴍᴇᴛᴀᴅᴀᴛᴀ', callback_data='howmetadata')
                ],[
        ...
        buttons = [[InlineKeyboardButton('⟲ ʀᴇʟᴏᴀᴅ', callback_data='stats'),
        ...
        await query.message.edit_text(
            text=Txt.FILE_NAME_TXT.format(format_template=format_template if format_template else "Not Set Yet"),
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[
                InlineKeyboardButton("✘ ᴄʟᴏsᴇ", callback_data="close"),
                InlineKeyboardButton("⟪ ʙᴀᴄᴋ", callback_data="help")
        ...
        await query.message.edit(text=text, reply_markup=await feature_keyboard(user_id))
        ...
        await query.message.reply_text("__**ᴘʟᴇᴀsᴇ ᴇɴᴛᴇʀ ɴᴇᴡ ғɪʟᴇ ɴᴀᴍᴇ...**__",
        ...
        if type == 'video':
            if not autorename:
                return await query.answer(f'ʜᴇʏ {query.from_user.first_name},\n\nᴀᴜᴛᴏ-ʀᴇɴᴀᴍᴇ ᴍᴜsᴛ ʙᴇ ᴇɴᴀʙʟᴇᴅ ʙᴇғᴏʀᴇ ᴄʜᴀɴɢɪɴɢ ᴛʜᴇ ғɪʟᴇ ᴛʏᴘᴇ.', show_alert=True)
        ...
        btn = [[InlineKeyboardButton('ᴘᴀʏ ᴛᴏ ᴀᴅᴍɪɴ', url='https://t.me/Snowball_Official')], [
        InlineKeyboardButton('ᴄʟᴏsᴇ ✘', callback_data='close')]]
